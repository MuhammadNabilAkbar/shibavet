  ...
  <div class="wrapper">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="../Data/process.php" class="nav-link active">
            ...
            <div class="card">
              ...
              <div class="card-body p-0 table-responsive" style="max-height: 535px; table-layout:fixed; overflow:auto;">
                ...
                include '../../Back/conn.php';    ?>
                  <div class="card card-secondary <?php if($_SESSION['username'] == 'admin'){echo'';}else{echo'hide';}?>">
                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                          ...
                          <tbody>
                            <?php
                                include'../../Back/conn.php';
                                $no = 1;
                                $query = mysqli_query($conn, "SELECT * FROM tb_bookinginap WHERE status_inap='Menunggu Pembayaran'");                      
                            ...
                            <tr>
                              ...
                              <div class="btn-group btn-group-sm">
                                  <a href="https://api.whatsapp.com/send?phone=62<?=$d['telp_inap']?>&text=Halo,%0aDengan%20ibu/bapak%20<?=$d['nama_inap']?>%20ada%20yang%20bisa%20dibantu?"
                                    class="btn btn-outline-warning"><i class="fas fa-phone"></i></a>
                                </div>                               
                                  <div class="btn-group btn-group-sm">
                                    <a href="../../Back/exc-processinap.php?telp_inap=<?= $d['telp_inap'];?>"
                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                          ...
                          <tbody>
                            <?php
                              include'../../Back/conn.php';
                              $no = 1;
                              $query = mysqli_query($conn, "SELECT * FROM tb_bookingdokter WHERE status_bdokter='Menunggu Pembayaran'");
                              while($d = mysqli_fetch_array($query)){
                              ?>
                            <tr>
                              <td><?=$no++;?></td>
                              ...
                              <td>
                              <div class="btn-group btn-group-sm">
                                  <a href="https://api.whatsapp.com/send?phone=62<?=$d['telp_bdokter']?>&text=Halo,%0aDengan%20ibu/bapak%20<?=$d['nama_bdokter']?>%20ada%20yang%20bisa%20dibantu?"
                                    class="btn btn-outline-warning"><i class="fas fa-phone"></i></a>
                                </div>                                
                                  <div class="btn-group btn-group-sm">
                                    <a href="../../Back/exc-processdokter.php?telp_bdokter=<?= $d['telp_bdokter'];?>"
                                      class="btn btn-outline-success"><i class="fas fa-check"></i></a>
                                  </div>                                
                              </td>
                            </tr>
                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                          ...
                          <tbody>
                            <?php
                              include'../../Back/conn.php';
                              $no = 1;
                              $query = mysqli_query($conn, "SELECT * FROM tb_grooming WHERE status_grooming='Menunggu Pembayaran'");
                              while($d = mysqli_fetch_array($query)){
                              ?>
                            <tr>
                              <td><?=$no++;?></td>
                              ...
                              <td>        
                              <div class="btn-group btn-group-sm">
                                  <a href="https://api.whatsapp.com/send?phone=62<?=$d['telp_grooming']?>&text=Halo,%0aDengan%20ibu/bapak%20<?=$d['nama_grooming']?>%20ada%20yang%20bisa%20dibantu?"
                                    class="btn btn-outline-warning"><i class="fas fa-phone"></i></a>
                                </div>                        
                                  <div class="btn-group btn-group-sm">
                                    <a href="../../Back/exc-processgrooming.php?telp_grooming=<?= $d['telp_grooming'];?>"
                                      class="btn btn-outline-success"><i class="fas fa-check"></i></a>
                                  </div>                                
                              </td>
                            </tr>
                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                          ...
                          <tbody>
                            <?php
                              include'../../Back/conn.php';
                              $no = 1;
                              $query = mysqli_query($conn, "SELECT * FROM tb_konsulon WHERE status_konsulon='Menunggu Pembayaran'");
                              while($d = mysqli_fetch_array($query)){
                              ?>
                            <tr>
                              <td><?=$no++;?></td>
                              ...
                              <td>
                              <div class="btn-group btn-group-sm">
                                  <a href="https://api.whatsapp.com/send?phone=62<?=$d['telp_konsulon']?>&text=Halo,%0aDengan%20ibu/bapak%20<?=$d['nama_konsulon']?>%20ada%20yang%20bisa%20dibantu?"
                                    class="btn btn-outline-warning"><i class="fas fa-phone"></i></a>
                                </div>
                                <div class="btn-group btn-group-sm">
                                <a href="../../Back/exc-processkonsulon.php?telp_konsulon=<?= $d['telp_konsulon'];?>"
                                      class="btn btn-outline-success"><i class="fas fa-check"></i></a>
                                </div>
