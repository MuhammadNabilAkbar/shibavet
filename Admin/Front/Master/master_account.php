      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-open">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../Master/master_account.php" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            <button type="button" class="btn btn-block btn-info" data-toggle="modal" data-target="#modal-md"><i
                class="fas fa-solid fa-plus"></i>&nbsp;&nbsp;Buat Akun Baru</button>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <?php
                        ...
                        }elseif($d['role'] == 'dokter'){
                          echo'<td><span class="badge bg-light">Dokter</span></td>';
                        }else{
                          echo'error';
                        }
                        ?>
      ...
      <div class="modal fade" id="modal-md">
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            ...
            <form action="../../Back/exc-addaccount.php" method="POST">
                      ...
                      <form id="quickForm">
                        <div class="card-body">
                          <div class="form-group">
                            ...
                            <input required type="text" name="username" class="form-control" placeholder="Nama">
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <select required name="role" class="custom-select rounded-0" id="exampleSelectRounded0">
